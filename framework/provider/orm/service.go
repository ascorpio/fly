...
// NewFlyGorm 代表实例化Gorm
func NewFlyGorm(params ...interface{}) (interface{}, error) {
...
// GetDB 获取DB实例
func (app *FlyGorm) GetDB(option ...contract.DBOption) (*gorm.DB, error) {
