...
func NewFlyTraceService(params ...interface{}) (interface{}, error) {
	c := params[0].(framework.Container)
	idService := c.MustMake(contract.IDKey).(contract.IDService)
	return &FlyTraceService{idService: idService}, nil
}

// WithTrace register new trace to context
func (t *FlyTraceService) WithTrace(c context.Context, trace *contract.TraceContext) context.Context {
...
func (t *FlyTraceService) GetTrace(c context.Context) *contract.TraceContext {
	if ginC, ok := c.(*gin.Context); ok {
...
func (t *FlyTraceService) NewTrace() *contract.TraceContext {
...
func (t *FlyTraceService) StartSpan(tc *contract.TraceContext) *contract.TraceContext {
...
// GetTrace By Http
func (t *FlyTraceService) ExtractHTTP(req *http.Request) *contract.TraceContext {
	tc := &contract.TraceContext{}
...
// Set Trace to Http
func (t *FlyTraceService) InjectHTTP(req *http.Request, tc *contract.TraceContext) *http.Request {
...
func (t *FlyTraceService) ToMap(tc *contract.TraceContext) map[string]string {
	m := map[string]string{}
	if tc == nil {
		return m
	}
...
// func (t *FlyTraceService) SetTraceIDService(service contract.IDService) {
// 	t.traceIDGenerator = service
// }

// func (t *FlyTraceService) SetSpanIDService(service contract.IDService) {
