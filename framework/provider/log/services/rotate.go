...
// FlyRotateLog 代表会进行切割的日志文件存储
type FlyRotateLog struct {
	FlyLog
...
// NewFlyRotateLog 实例化FlyRotateLog
func NewFlyRotateLog(params ...interface{}) (interface{}, error) {
	// 参数解析
